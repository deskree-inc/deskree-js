...
| sessionId   | string    | The ID of the OAUTH session returned from [createUrlForOAuthSignIn()](broken-reference)                                                                                                                                                                                                                                                                        |
| callBackUri | string    | URL to redirect users after a successful OAUTH sign-in.                                                                                                                                                                                                                                                                                                        |
| token       | string    | <p><strong>Used only for Google and Facebook sign-in.</strong> </p><p><strong></strong></p><p>If the token is provided, <code>code</code> parameter is ignored.</p><p><strong></strong></p><p>The parameter will be returned in the <code>callBackUri</code> of <a href="broken-reference">createUrlForOAuthSignIn()</a> after a successful OAUTH sign-in.</p> |
| code        | string    | The parameter will be returned in the `callBackUri` of [createUrlForOAuthSignIn()](broken-reference) after a successful OAUTH sign-in.                                                                                                                                                                                                                         |
